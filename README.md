...
| 08 | [**Conversational Memory**](./08-Conversational_Memory) | Buffer, Summary, Window, Entity memory | ✅ |
| 09 | [**Agents & Custom Tools**](./09-Agents_&_Custom_tools) | ReAct agent, custom tools, tool routing | ✅ |
| 10 | [**Callbacks & Tracing**](./10-Callback_&_Tracing) | Custom handlers, LangSmith, cost tracking | ✅ |
